...
class Http
{
     ...
     * @param bool $getHeader 是否获取头部信息
     * @return boolean|string
     */
    public static function get($url, $query = [], $options = [], $getHeader = false)
    {
        $options['query'] = $query;
        return self::request('get', $url, $options, $getHeader);
    }
     ...
     * @return boolean|string
     */
    public static function post($url, $data = [], $options = [], $getHeader = false)
    {
        $options['data'] = $data;
        return self::request('post', $url, $options, $getHeader = false);
    }
     ...
     * @return boolean|string
     */
    public static function request($method, $url, $options = [], $getHeader = false)
    {
        $curl = curl_init();
        // GET 参数设置
